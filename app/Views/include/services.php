<section class="pt-20 lg:pt-[120px] pb-12 lg:pb-[90px] linear-bg" id="service">
    <div class="container">
               ...
               ">
                  ...
                  ">
                    ...
                    <p class="text-body-color">
                        Choose from a wide range of courses that fit your schedule and interests.
                    </p>
                </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 px-4">
		...
		c0,1.9,0.9,3.7,2.4,4.8C2.2,12.2,0,15.3,0,19v5h12v-2H2V19z M5,6c0-2.2,1.8-4,4-4s4,1.8,4,4s-1.8,4-4,4S5,8.2,5,6z" />
                    ...
                    <p class="text-body-color">
                        Learn from experienced professionals in the field who are passionate about teaching.
                    </p>
                </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 px-4">
	...
	l46.293,46.293l17.36-17.36L56.972,126.433z" />
                    ...
                    <p class="text-body-color">
                        Receive guidance and resources to help you advance in your career after completing a course.
                    </p>
                </div>
            </div>
        </div>
